export const states = [
    ...
    {
      state: "Idaho",
      cities: ["Boise City", "Nampa", "Meridian", "Idaho Falls", "Pocatello", "Caldwell", "Coeur d'Alene", "Twin Falls"],
    },
    {
      state: "Illinois",
      cities: [
    ...
    {
      state: "Kentucky",
      cities: ["Louisville/Jefferson County", "Lexington-Fayette", "Bowling Green", "Owensboro", "Covington"],
    },
    {
      state: "Louisiana",
      cities: [
    ...
    {
      state: "Maryland",
      cities: ["Baltimore", "Frederick", "Rockville", "Gaithersburg", "Bowie", "Hagerstown", "Annapolis"],
    },
    {
      state: "Massachusetts",
      cities: [
    ...
    {
      state: "South Dakota",
      cities: ["Pierre", "Sioux Falls", "Rapid City"],
    },
    {
      state: "Tennessee",
      cities: [
